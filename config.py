...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/LyraUpdate")  
# Example:- https://t.me/TheYukki
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/LyraUpdate")  
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://telegra.ph/file/61c81ab512d54a8a26f0d.jpg")
...
# Images
START_IMG_URL = getenv("START_IMG_URL", "https://telegra.ph/file/70db0c8e900be14e1814b.jpg")

PING_IMG_URL = getenv(
    "PING_IMG_URL",
    "AnonX/assets/Ping.jpeg",
)

PLAYLIST_IMG_URL = getenv(
    "PLAYLIST_IMG_URL",
    "AnonX/assets/Playlist.jpeg",
)

GLOBAL_IMG_URL = getenv(
    "GLOBAL_IMG_URL",
    "AnonX/assets/Global.jpeg",
)

STATS_IMG_URL = getenv(
    "STATS_IMG_URL",
    "AnonX/assets/Stats.jpeg",
)

TELEGRAM_AUDIO_URL = getenv(
    "TELEGRAM_AUDIO_URL",
    "AnonX/assets/Audio.jpeg",
)

TELEGRAM_VIDEO_URL = getenv(
    "TELEGRAM_VIDEO_URL",
    "AnonX/assets/Video.jpeg",
)

STREAM_IMG_URL = getenv(
    "STREAM_IMG_URL",
    "AnonX/assets/Stream.jpeg",
)

SOUNCLOUD_IMG_URL = getenv(
    "SOUNCLOUD_IMG_URL",
    "AnonX/assets/Soundcloud.jpeg",
)
...
SPOTIFY_ARTIST_IMG_URL = getenv(
    ...
    "AnonX/assets/SpotifyArtist.jpeg",
)

SPOTIFY_ALBUM_IMG_URL = getenv(
    "SPOTIFY_ALBUM_IMG_URL",
    "AnonX/assets/SpotifyAlbum.jpeg",
)

SPOTIFY_PLAYLIST_IMG_URL = getenv(
    "SPOTIFY_PLAYLIST_IMG_URL",
    "AnonX/assets/SpotifyPlaylist.jpeg",
)
